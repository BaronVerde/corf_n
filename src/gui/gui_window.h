...
typedef enum {
	gui_float, gui_int, gui_unsigned_int, gui_bool
...
typedef struct {
	...
	GLsizei scissor_size_x;
	GLsizei scissor_size_y;
 ...
 * position upper left in screen pixels, size of the application window in pixels
 * as well as width and height od the gui window area (for gl scisoors).
...
void gui_window_set_size( const gui_window_t *const w, GLsizei size_x, GLsizei size_y );
